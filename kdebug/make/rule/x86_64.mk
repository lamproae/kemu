...
CFLAGS += -I$(PROJECT_DIR)/tools/toolchain/$(ARCH)/$(toolchain)/lib/gcc/$(toolchain)/5.3.0/plugin/include
CFLAGS += -I$(PROJECT_DIR)/tools/toolchain/$(ARCH)/$(toolchain)/lib/gcc/$(toolchain)/5.3.0/include
CFLAGS += -I$(PROJECT_DIR)/tools/toolchain/$(ARCH)/$(toolchain)/lib/gcc/$(toolchain)/5.3.0/install-tools/include
